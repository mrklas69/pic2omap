...
from omap_parser import iter_map_objects, parse_omap
...
def main() -> None:
    ...
    if args.db is not None:
        ...
        # Review krok 4 (per-symbol DB↔OMAP tabulka + CSV) žije v review_export.
        # Lazy import: review_export importuje GroundTruth odsud, takže import až
        # za běhu (po načtení tohoto modulu) drží jednosměrnou závislost bez cyklu.
        from review_export import (
            db_symbol_counts,
            format_per_symbol_table,
            load_db,
            parse_gt_objects,
            write_detected_csv,
            write_gt_csv,
